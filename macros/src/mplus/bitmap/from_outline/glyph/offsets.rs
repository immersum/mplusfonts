pub struct GlyphOffsets(pub u16, pub f32, pub f32);

impl GlyphOffsets {
    pub fn patch(&mut self, is_variable_width: bool, is_overlay: bool) {
        let Self(id, ref mut x_offset, ref mut y_offset) = *self;
